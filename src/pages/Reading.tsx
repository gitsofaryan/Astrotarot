      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-mystical bg-clip-text text-transparent">
              AstroTarot Reading
            </h1>
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="text-center space-y-4">
              <Button
                ...
                variant="outline"
                className="border-2 border-accent/60 hover:bg-accent/20 hover:border-accent hover:shadow-xl hover:shadow-accent/20 transition-all duration-500 h-12 text-lg font-semibold px-8 mr-4"
                size="lg"
              >
                <Sparkles className="w-6 h-6 mr-3" />
                New Reading
              ...
              <Button
                onClick={() => navigate('/')}
                variant="ghost"
                className="text-accent hover:bg-accent/20 transition-all duration-300 h-12 text-lg font-semibold px-8"
                size="lg"
              >
